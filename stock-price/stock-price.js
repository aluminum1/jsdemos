import { Rectangle, SetSVGContext, DrawGrid, DrawAxes, MakePolyLine, MakeSVGContext, SetBackgroundGradient, SetPoints } from "../modules/svg-draw.js";
...
const NUM_BINS = 100;
let svgElement = document.querySelector("#svgRoot");
...
const SIM_TICKS_PER_SECOND = 10100000; // (10 million!!! The 100 is there to prevent weird roundoff, I think having to do with bigints...)
...
function InitializeHistogram(ctx) {
    let bins = [];
